...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1374.181037741028; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1348.3577282899835; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -1577.6520712542278; // x position of the perpendicular encoder (in tick units)
    }
